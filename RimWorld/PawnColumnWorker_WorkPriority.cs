...
public class PawnColumnWorker_WorkPriority : PawnColumnWorker
{
	...
	public override void DoCell(Rect rect, Pawn pawn, PawnTable table)
	{
		...
		float num = ((Rect)(ref rect)).x + (((Rect)(ref rect)).width - 25f) / 2f;
		float num2 = ((Rect)(ref rect)).y + 2.5f;
		bool incapable = IsIncapableOfWholeWorkType(pawn, def.workType);
		WidgetsWork.DrawWorkBoxFor(num, num2, pawn, def.workType, incapable);
		Rect rect2 = default(Rect);
		((Rect)(ref rect2))._002Ector(num, num2, 25f, 25f);
	...
	public override void DoHeader(Rect rect, PawnTable table)
	{
		...
		Widgets.DrawLineVertical(((Rect)(ref labelRect)).center.x, ((Rect)(ref labelRect)).yMax - 3f, ((Rect)(ref rect)).y + 50f - ((Rect)(ref labelRect)).yMax + 3f);
		Widgets.DrawLineVertical(((Rect)(ref labelRect)).center.x + 1f, ((Rect)(ref labelRect)).yMax - 3f, ((Rect)(ref rect)).y + 50f - ((Rect)(ref labelRect)).yMax + 3f);
	...
	private Rect GetLabelRect(Rect headerRect)
	{
		...
		float x = ((Rect)(ref headerRect)).center.x;
		Rect result = default(Rect);
		((Rect)(ref result))._002Ector(x - cachedWorkLabelSize.x / 2f, ((Rect)(ref headerRect)).y, cachedWorkLabelSize.x, cachedWorkLabelSize.y);
		if (def.moveWorkTypeLabelDown)
		{
			((Rect)(ref result)).y = ((Rect)(ref result)).y + 20f;
		}
		return result;
	}
