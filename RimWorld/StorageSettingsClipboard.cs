...
public static class StorageSettingsClipboard
{
	...
	public static IEnumerable<Gizmo> CopyPasteGizmosFor(StorageSettings s)
	{
		...
		command_Action.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/CopySettings");
		...
		command_Action2.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/PasteSettings");
