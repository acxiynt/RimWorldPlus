	...
	protected void DoInfoBox(Rect infoRect, Designator designator)
	{
		...
		Find.WindowStack.ImmediateWindow(32520, infoRect, WindowLayer.GameUI, delegate
		{
			...
			if (designator != null)
			{
				...
				((Rect)(ref rect2))._002Ector(0f, 0f, ((Rect)(ref rect)).width - designator.PanelReadoutTitleExtraRightMargin, 999f);
				Text.Font = GameFont.Small;
				Widgets.Label(rect2, designator.LabelCap);
				float curY = Mathf.Max(24f, Text.CalcHeight(designator.LabelCap, ((Rect)(ref rect2)).width));
				designator.DrawPanelReadout(ref curY, ((Rect)(ref rect)).width);
				Rect val = default(Rect);
				((Rect)(ref val))._002Ector(0f, curY, ((Rect)(ref rect)).width, ((Rect)(ref rect)).height - curY);
				string desc = designator.Desc;
				GenText.SetTextSizeToFit(desc, val);
				desc = desc.TruncateHeight(((Rect)(ref val)).width, ((Rect)(ref val)).height);
				Widgets.Label(val, desc);
				Widgets.EndGroup();
			}
		});
	}
