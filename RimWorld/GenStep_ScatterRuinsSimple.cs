...
public class GenStep_ScatterRuinsSimple : GenStep_Scatterer
{
	...
	protected override void ScatterAt(IntVec3 c, Map map, GenStepParams parms, int stackCount = 1)
	{
		...
		RimWorld.SketchGen.SketchGen.Generate(parms: new ResolveParams
		{
			sketch = new Sketch(),
			monumentSize = new IntVec2(rect.Width, rect.Height),
			destroyChanceExp = destroyChanceExp
		}, root: SketchResolverDefOf.MonumentRuin).Spawn(map, rect.CenterCell, null, Sketch.SpawnPosType.Unchanged, Sketch.SpawnMode.Normal, wipeIfCollides: false, clearEdificeWhereFloor: false, null, dormant: false, buildRoofsInstantly: false, delegate(SketchEntity entity, IntVec3 cell)
		{
