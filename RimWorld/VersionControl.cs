...
public static class VersionControl
{
	...
	public static void DrawInfoInCorner()
	{
		...
		((Rect)(ref rect))._002Ector(10f, 10f, 330f, Text.CalcHeight(text, 330f));
		Widgets.Label(rect, text);
		GUI.color = Color.white;
		LatestVersionGetter component = ((Component)Current.Root).gameObject.GetComponent<LatestVersionGetter>();
		Rect rect2 = default(Rect);
		((Rect)(ref rect2))._002Ector(10f, ((Rect)(ref rect)).yMax - 5f, 330f, 999f);
