...
public class SketchResolver_Monument : SketchResolver
{
	...
	protected override void ResolveInt(ResolveParams parms)
	{
		...
		if (num9 != 0 && !flag && !monument.Things.Any((SketchThing x) => x.def == ThingDefOf.Door) && monument.Things.Where((SketchThing t) => IsWallBorderingEdge(monument, t)).TryRandomElement(out var result2))
		{
