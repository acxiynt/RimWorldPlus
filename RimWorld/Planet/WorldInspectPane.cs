...
public class WorldInspectPane : Window, IInspectPane
{
	...
	private string TileInspectString
	{
		get
		{
			...
			{
				string text = (WorldPathGrid.CalculatedMovementDifficultyAt(SelectedTile, perceivedStatic: false) * Find.WorldGrid.GetRoadMovementDifficultyMultiplier(SelectedTile, -1)).ToString("0.#");
				stringBuilder.AppendLine();
