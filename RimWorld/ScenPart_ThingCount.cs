...
public abstract class ScenPart_ThingCount : ScenPart
{
	...
	public override void DoEditInterface(Listing_ScenEdit listing)
	{
		...
		Rect rect = new Rect(((Rect)(ref scenPartRect)).x, ((Rect)(ref scenPartRect)).y, ((Rect)(ref scenPartRect)).width, ((Rect)(ref scenPartRect)).height / 4f);
		Rect rect2 = default(Rect);
		((Rect)(ref rect2))._002Ector(((Rect)(ref scenPartRect)).x, ((Rect)(ref scenPartRect)).y + ((Rect)(ref scenPartRect)).height / 4f, ((Rect)(ref scenPartRect)).width, ((Rect)(ref scenPartRect)).height / 4f);
		Rect rect3 = default(Rect);
		((Rect)(ref rect3))._002Ector(((Rect)(ref scenPartRect)).x, ((Rect)(ref scenPartRect)).y + ((Rect)(ref scenPartRect)).height * 2f / 4f, ((Rect)(ref scenPartRect)).width, ((Rect)(ref scenPartRect)).height / 4f);
		Rect rect4 = default(Rect);
		((Rect)(ref rect4))._002Ector(((Rect)(ref scenPartRect)).x, ((Rect)(ref scenPartRect)).y + ((Rect)(ref scenPartRect)).height * 3f / 4f, ((Rect)(ref scenPartRect)).width, ((Rect)(ref scenPartRect)).height / 4f);
