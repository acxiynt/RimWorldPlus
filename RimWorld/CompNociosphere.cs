...
public class CompNociosphere : CompInteractable, IActivity, IRoofCollapseAlert
{
	...
	{
		GenExplosion.DoExplosion(Pawn.PositionHeld, prevMap, 4.9f, DamageDefOf.Vaporize, Pawn, -1, -1f, null, null, null, null, null, 0f, 1, null, applyDamageToExplosionCellsNeighbors: false, null, 0f, 1, 0f, damageFalloff: false, null, thingsIgnoredByExplosion);
