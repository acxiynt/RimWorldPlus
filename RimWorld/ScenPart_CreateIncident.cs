...
internal class ScenPart_CreateIncident : ScenPart_IncidentBase
{
	...
	public override void DoEditInterface(Listing_ScenEdit listing)
	{
		...
		((Rect)(ref rect))._002Ector(((Rect)(ref scenPartRect)).x, ((Rect)(ref scenPartRect)).y, ((Rect)(ref scenPartRect)).width, ((Rect)(ref scenPartRect)).height / 3f);
		Rect rect2 = default(Rect);
		((Rect)(ref rect2))._002Ector(((Rect)(ref scenPartRect)).x, ((Rect)(ref scenPartRect)).y + ((Rect)(ref scenPartRect)).height / 3f, ((Rect)(ref scenPartRect)).width / 2f, ((Rect)(ref scenPartRect)).height / 3f);
		Rect rect3 = default(Rect);
		((Rect)(ref rect3))._002Ector(((Rect)(ref scenPartRect)).x + ((Rect)(ref scenPartRect)).width / 2f, ((Rect)(ref scenPartRect)).y + ((Rect)(ref scenPartRect)).height / 3f, ((Rect)(ref scenPartRect)).width / 2f, ((Rect)(ref scenPartRect)).height / 3f);
		Rect rect4 = new Rect(((Rect)(ref scenPartRect)).x, ((Rect)(ref scenPartRect)).y + ((Rect)(ref scenPartRect)).height * 2f / 3f, ((Rect)(ref scenPartRect)).width, ((Rect)(ref scenPartRect)).height / 3f);
