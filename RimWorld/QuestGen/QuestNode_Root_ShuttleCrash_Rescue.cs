...
public class QuestNode_Root_ShuttleCrash_Rescue : QuestNode
{
	...
	protected override void RunInt()
	{
		...
		quest.Delay(120, delegate
		{
			...
			quest.ExitOnShuttle(map.Parent, allPassengers, Faction.OfEmpire, rescueShuttle, inSignal4, addFleeToil: false);
		...
		quest.SignalPass(delegate
		{
			...
			quest.GiveRewards(parms, null, null, null, null, null, null, null, null, addCampLootReward: false, asker, addShuttleLootReward: true);
