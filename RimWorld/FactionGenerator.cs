...
public static class FactionGenerator
{
	...
	public static void GenerateFactionsIntoWorld(List<FactionDef> factions = null)
	{
		...
		if (source.Any())
		{
			int num2 = GenMath.RoundRandom((float)Find.WorldGrid.TilesCount / 100000f * SettlementsPer100kTiles.RandomInRange * Find.World.info.overallPopulation.GetScaleFactor());
