...
public static class ReadingColumnUIUtility
{
	...
	public static void DoAssignReadingButtons(Rect rect, Pawn pawn)
	{
		...
		Widgets.Dropdown(rect2, pawn, (Pawn p) => p.reading.CurrentPolicy, Button_GenerateMenu, label.Truncate(((Rect)(ref rect2)).width), null, pawn.reading.CurrentPolicy.label, null, null, paintable: true);
