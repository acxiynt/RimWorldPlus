	...
	public override void Apply(LocalTargetInfo target, LocalTargetInfo dest)
	{
		...
		if (thing.Stuff != null)
		{
			...
			if (thing is UnfinishedThing unfinishedThing)
			{
				...
				if (num3 <= 0)
				{
					Debug.LogError((object)("Attempted to transmute an unfinished thing but could not generate enough replacement items (" + stuff.label + " to " + thingDef.label + "). Check if " + thingDef.label + " is stackable."));
				}
			}
			string text3 = "";
