...
public abstract class PawnOverlayDrawer
{
	...
	protected struct CacheKey : IEquatable<CacheKey>
	{
		...
		public CacheKey(Mesh bodyMesh, Rot4 pawnRot, OverlayLayer layer)
		{
			...
			this.layer = layer;
			hash = ((!((Object)(object)bodyMesh == (Object)null)) ? ((object)bodyMesh).GetHashCode() : 0);
		...
		{
			if ((Object)(object)other.bodyMesh == (Object)(object)bodyMesh && other.pawnRot == pawnRot)
			{
	...
	private void DoDrawCall(DrawCall call, Matrix4x4 matrix, bool drawNow)
	{
		...
		else
		{
			...
			Graphics.DrawMesh(call.overlayMesh, matrix * call.matrix, call.overlayMat, 0, (Camera)null, 0, propBlock);
		}
	}
}
