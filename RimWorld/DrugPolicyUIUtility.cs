...
public static class DrugPolicyUIUtility
{
	...
	public static void DoAssignDrugPolicyButtons(Rect rect, Pawn pawn)
	{
		...
		Widgets.Dropdown(rect2, pawn, (Pawn p) => p.drugs.CurrentPolicy, Button_GenerateMenu, text.Truncate(((Rect)(ref rect2)).width), null, pawn.drugs.CurrentPolicy.label, null, delegate
		{
