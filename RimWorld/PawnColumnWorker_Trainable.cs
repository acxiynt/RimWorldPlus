	...
	public override void DoCell(Rect rect, Pawn pawn, PawnTable table)
	{
		...
		if (pawn.training != null)
		{
			...
			if (visible && canTrain.Accepted)
			{
				...
				TrainingCardUtility.DoTrainableCheckbox(new Rect(((Rect)(ref rect)).x + (float)num, ((Rect)(ref rect)).y + (float)num2, 24f, 24f), pawn, def.trainable, canTrain, drawLabel: false, doTooltip: true);
			}
		}
	}
