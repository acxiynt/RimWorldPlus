...
public class Reward_DevelopmentPoints : Reward
{
	...
	public override IEnumerable<GenUI.AnonymousStackElement> StackElements
	{
		get
		{
			...
			if (num > 0)
			{
				yield return QuestPartUtility.GetStandardRewardStackElement((string)("Reward_DevelopmentPointsLabel".Translate() + ": " + num.ToStringWithSign()), (Action<Rect>)delegate(Rect rect)
				{
