...
public class CompDisruptorFlare : ThingComp
{
	...
	private float WarnAlpha => Mathf.InverseLerp((float)WarnTick, (float)destroyDelayedComp.DestructionTick, (float)Find.TickManager.TicksGame);
	...
	public override void CompTick()
	{
		...
		if (Find.TickManager.TicksGame >= WarnTick)
		{
			...
			glowColor.a = (byte)Mathf.Lerp((float)glowColor.a, 0f, warnAlpha);
