...
public class PawnColumnWorker_Bond : PawnColumnWorker_Icon
{
	...
	public int GetCompareValueFor(Pawn a)
	{
		...
		if ((Object)(object)iconFor == (Object)(object)BondBrokenIcon)
		{
			return 1;
		}
		if ((Object)(object)iconFor == (Object)(object)BondIcon)
		{
			return 2;
		}
	...
	{
		if (!((Object)(object)GetIconFor(pawn) != (Object)(object)BondBrokenIcon) && pawn.training.HasLearned(TrainableDefOf.Obedience))
		{
