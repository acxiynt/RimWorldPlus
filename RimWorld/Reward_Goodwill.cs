...
public class Reward_Goodwill : Reward
{
	...
	public override IEnumerable<GenUI.AnonymousStackElement> StackElements
	{
		get
		{
			yield return QuestPartUtility.GetStandardRewardStackElement((string)("Goodwill".Translate() + " " + amount.ToStringWithSign()), (Action<Rect>)delegate(Rect r)
			{
			...
			}, (Func<string>)(() => "GoodwillTip".Translate(faction, amount, -75, 75, faction.PlayerGoodwill, faction.PlayerRelationKind.GetLabelCap()).Resolve()), (Action)delegate
			{
