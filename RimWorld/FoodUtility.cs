...
public static class FoodUtility
{
	...
	private static HashSet<Thing> filtered;

	private static readonly SimpleCurve FoodOptimalityEffectFromMoodCurve;

	private static List<Pawn> tmpPredatorCandidates;

	private static List<ThoughtFromIngesting> ingestThoughts;

	private static List<ThoughtDef> extraIngestThoughtsFromTraits;
	...
	static FoodUtility()
	{
		...
		FoodOptimalityEffectFromMoodCurve = new SimpleCurve
		{
		...
		ingestThoughts = new List<ThoughtFromIngesting>();
		extraIngestThoughtsFromTraits = new List<ThoughtDef>();
	}
}
