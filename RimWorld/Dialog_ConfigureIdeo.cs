...
public class Dialog_ConfigureIdeo : Window
{
	...
	public override Vector2 InitialSize => new Vector2(1100f, Mathf.Min(1000f, (float)UI.screenHeight));
	...
	public override void DoWindowContents(Rect inRect)
	{
		...
		Widgets.Label(new Rect(((Rect)(ref inRect)).x, ((Rect)(ref inRect)).y, ((Rect)(ref inRect)).width, 45f), "ConfigureIdeoligion".Translate());
		Text.Font = GameFont.Small;
		IdeoUIUtility.DoIdeoListAndDetails(new Rect(((Rect)(ref inRect)).x, ((Rect)(ref inRect)).y + 45f, ((Rect)(ref inRect)).width, ((Rect)(ref inRect)).height - 55f - 45f), ref scrollPosition_ideoList, ref scrollViewHeight_ideoList, ref scrollPosition_ideoDetails, ref scrollViewHeight_ideoDetails, customOrLoadedIdeo != null, showCreateIdeoButton: true, pawns, customOrLoadedIdeo, delegate
		{
			CreateNewIdeo();
		...
		if (Widgets.ButtonText(new Rect(((Rect)(ref inRect)).xMax - Window.CloseButSize.x - 18f, ((Rect)(ref inRect)).height - 55f, Window.CloseButSize.x, Window.CloseButSize.y), "Next".Translate()))
		{
		...
		if (source.Any() && Widgets.ButtonText(new Rect(((Rect)(ref inRect)).center.x - AssignColonistsBtnSize.x / 2f, ((Rect)(ref inRect)).height - 55f, AssignColonistsBtnSize.x, AssignColonistsBtnSize.y), "AssignColonists".Translate()))
		{
		...
		((Rect)(ref rect))._002Ector(((Rect)(ref inRect)).x + 18f, ((Rect)(ref inRect)).height - 55f, ChangeOrDeleteIdeoBtnSize.x, ChangeOrDeleteIdeoBtnSize.y);
