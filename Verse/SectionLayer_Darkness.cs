...
public class SectionLayer_Darkness : SectionLayer
{
	...
	public override void DrawLayer()
	{
		...
		float num = Mathf.Clamp01(1f - Mathf.Max(base.Map.gameConditionManager.MapBrightness, base.Map.skyManager.CurSkyGlow));
		propertyBlock.SetColor(ShaderPropertyIDs.ColorTwo, new Color(1f, 1f, 1f, num));
