...
public class SampleOneShotManager
{
	...
	public void SampleOneShotManagerUpdate()
	{
		...
		for (int j = 0; j < samples.Count; j++)
		{
			...
			if ((Object)(object)sampleOneShot.source == (Object)null || (!sampleOneShot.source.isPlaying && (!sampleOneShot.subDef.tempoAffectedByGameSpeed || !Find.TickManager.Paused)) || !SoundDefHelper.CorrectContextNow(sampleOneShot.subDef.parentDef, sampleOneShot.Map))
			{
				if ((Object)(object)sampleOneShot.source != (Object)null && sampleOneShot.source.isPlaying)
				{
					sampleOneShot.source.Stop();
				}
