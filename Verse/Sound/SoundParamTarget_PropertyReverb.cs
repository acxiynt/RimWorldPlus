...
public class SoundParamTarget_PropertyReverb : SoundParamTarget
{
	...
	{
		AudioReverbFilter val = ((Component)sample.source).GetComponent<AudioReverbFilter>();
		if ((Object)(object)val == (Object)null)
		{
			val = ((Component)sample.source).gameObject.AddComponent<AudioReverbFilter>();
		}
