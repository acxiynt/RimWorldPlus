...
public abstract class Zone : IExposable, ISelectable, ILoadReferenceable, IRenameable
{
	...
	public Material Material
	{
		get
		{
			...
			if ((Object)(object)materialInt == (Object)null)
			{
	...
	public virtual IEnumerable<Gizmo> GetGizmos()
	{
		...
		command_Toggle.icon = (Texture)(object)ContentFinder<Texture2D>.Get("UI/Commands/HideZone");
		...
		command_Action.icon = (Texture)(object)TexButton.Delete;
