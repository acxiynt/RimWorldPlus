...
public static class TexGame
{
	...
	static TexGame()
	{
		...
		Shader.SetGlobalTexture("_NoiseTex", (Texture)(object)NoiseTex);
		Shader.SetGlobalTexture("_RippleTex", (Texture)(object)RippleTex);
		Shader.SetGlobalTexture("_SpecularNoiseTex", (Texture)(object)SpecularNoiseTex);
	}
}
