	...
	public override void PostExposeData(object obj)
	{
		...
		if (obj is Pawn pawn)
		{
			...
			if (pawn.equipment != null && pawn.apparel != null && pawn.inventory != null)
			{
				...
				for (int num = 0; num < pawn.equipment.AllEquipmentListForReading.Count; num++)
				{
					ThingWithComps thingWithComps = pawn.equipment.AllEquipmentListForReading[num];
			...
			for (int num2 = 0; num2 < allEquipmentListForReading.Count; num2++)
			{
				if (allEquipmentListForReading[num2].def.defName == "Gun_Slugthrower")
				{
					pawn.equipment.Remove(allEquipmentListForReading[num2]);
					break;
				}
			}
		}
