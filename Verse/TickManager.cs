...
public sealed class TickManager : IExposable
{
	...
	public bool Paused
	{
		get
		{
			if (curTimeSpeed != TimeSpeed.Paused && (Find.WindowStack == null || !Find.WindowStack.WindowsForcePause) && !LongEventHandler.ForcePause)
			{
	...
	public bool NotPlaying => Find.MainTabsRoot.OpenTab == MainButtonDefOf.Menu;
