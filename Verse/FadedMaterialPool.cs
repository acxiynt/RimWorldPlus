...
public static class FadedMaterialPool
{
	private struct FadedMatRequest : IEquatable<FadedMatRequest>
	{
		...
		{
			if ((Object)(object)mat == (Object)(object)other.mat)
			{
		...
		{
			return Gen.HashCombineInt(((object)mat).GetHashCode(), alphaIndex);
		}
	...
	public static long TotalMaterialBytes
	{
		get
		{
			...
			{
				num += Profiler.GetRuntimeMemorySizeLong((Object)(object)cachedMat.Value);
			}
			return num;
		}
	}
