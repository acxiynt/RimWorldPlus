...
public class SectionLayer_IndoorMask : SectionLayer
{
	...
	private static void AppendQuadsToMesh(LayerSubMesh mesh, int x, int z, float overage)
	{
		...
		mesh.verts.Add(new Vector3((float)x - overage, num, (float)z - overage));
		mesh.verts.Add(new Vector3((float)x - overage, num, (float)(z + 1) + overage));
		mesh.verts.Add(new Vector3((float)(x + 1) + overage, num, (float)(z + 1) + overage));
		mesh.verts.Add(new Vector3((float)(x + 1) + overage, num, (float)z - overage));
